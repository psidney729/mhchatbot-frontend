    ...
    <Container maxWidth='lg'>
      <Box sx={{ my: 2 }}>
        ...
        <Typography variant='body1' sx={{ mb: 3 }}>
          Enter a description of the patient's situation to predict the likely response type and
        ...
        <Button variant='contained' onClick={handlePredict} disabled={loading} sx={{ mb: 4 }}>
          {loading ? (
            <>
          ...
          <Card sx={{ mb: 4 }}>
            <CardContent>
              ...
              <Box sx={{ mb: 2 }}>
                ...
                <Chip label={predictions.problem_type} color='primary' sx={{ mt: 1 }} />
              </Box>
              ...
              <Box sx={{ mb: 2 }}>
                ...
                <Chip label={predictions.response_type} color='secondary' sx={{ mt: 1 }} />
              ...
              <Box sx={{ mb: 2 }}>
                ...
                <Box sx={{ display: 'flex', gap: 1, flexWrap: 'wrap', mt: 1 }}>
                  {predictions.likely_issues.map((issue, index) => (
                    <Chip key={index} label={issue} variant='outlined' size='small' />
                  ))}
                </Box>
              </Box>
